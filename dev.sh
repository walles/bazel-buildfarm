...
ssh gew1-preprodbuildfarmworker-d-076x.gew1.spotify.net sudo java -XX:StartFlightRecording=delay=5s,duration=120s,settings=profile,filename=/tmp/$(date +%Y_%m_%d-%H_%M_%S).jfr -jar buildfarm-shard-worker_deploy.jar /etc/spotify/worker.config
